...
const IMAGEKIT_PRIVATE_KEY = process.env.IMAGEKIT_PRIVATE_KEY || process.env.VITE_IMAGEKIT_PRIVATE_KEY

if (!SUPABASE_URL || !SERVICE_ROLE_KEY || !IMAGEKIT_PRIVATE_KEY) {
  console.error('Missing VITE_SUPABASE_URL, SUPABASE_SERVICE_ROLE_KEY, or IMAGEKIT_PRIVATE_KEY in .env')
  process.exit(1)
}
